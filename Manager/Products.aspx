    ...
    <div class=" card-body text-dark bg-light mb-3">
        <table class="w-100 mt-3">
            <tr>
                ...
                <td>
                    <div class="form-data forms-inputs">
                        <span>Product Name</span>
                        <asp:TextBox ID="txtProductName" runat="server" CssClass="w-75" TextMode="SingleLine"></asp:TextBox>
                ...
                <td colspan="4">
                    ...
                    <div class="form-data">
                        <center>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:MyCon %>" SelectCommand="SELECT [CategoryID] FROM [Category] WHERE ([CategoryName] = @CategoryName)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlCategory" DefaultValue="~Select~" Name="CategoryName" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </center>
                    </div>
